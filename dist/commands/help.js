...
async function helpCommand(_args = []) {
    ...
    console.log((0, console_1.indent)(`${(0, console_1.formatCommand)("sui setup <type>")}      Scaffold a full app setup (crm | erp | saas | auth)`));
    console.log((0, console_1.indent)(`${(0, console_1.formatCommand)("sui add crm-setup")}     Shorthand: scaffold a CRM setup`));
    console.log((0, console_1.indent)(`${(0, console_1.formatCommand)("sui add erp-setup")}     Shorthand: scaffold an ERP setup`));
    console.log((0, console_1.indent)(`${(0, console_1.formatCommand)("sui add saas-setup")}    Shorthand: scaffold a SaaS setup`));
    console.log((0, console_1.indent)(`${(0, console_1.formatCommand)("sui add auth-setup")}    Shorthand: scaffold an Auth-only setup`));
